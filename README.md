...
- My firmware (https://github.com/summertianxia/tmk_keyboard.git/Tian-hhkb.hex)
#### Problems
If I flash the keyboard more than one time, I got the "dfu-programmer: no device present." error message sometimes. It's a common error  (https://github.com/dfu-programmer/dfu-programmer/issues/33). I solved the problem by pressing the reset button on HHKB. 
